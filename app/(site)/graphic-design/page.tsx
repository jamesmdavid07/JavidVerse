...
export default function GraphicPage() {
  return (
    <>
      ...
      {/* OneVoice27 — East Nairobi Field */}
      <section id="east-nairobi-field" className="relative scroll-mt-20 overflow-hidden px-6 py-12 sm:px-8 sm:py-14 lg:px-12 bg-gradient-to-br from-violet-50 via-indigo-50/60 to-blue-50">
        ...
        <div className="relative mx-auto max-w-7xl">
          <h2 className="text-center text-sm font-bold uppercase tracking-[0.2em] text-primary/60 sm:text-[0.8rem]">East Nairobi Field</h2>
          <div className="mt-8 grid gap-4 lg:grid-cols-[1.03fr_0.97fr] lg:items-start lg:gap-6">
            ...
            <div className="contents lg:flex lg:flex-col lg:gap-4">
              ...
              <OneVoiceShare anchor="east-nairobi-field" />
            </div>
      ...
      {/* Other missions — duplicate */}
      <section id="other-missions" className="relative scroll-mt-20 overflow-hidden px-6 py-12 sm:px-8 sm:py-14 lg:px-12 bg-gradient-to-br from-violet-50 via-indigo-50/60 to-blue-50">
        {/* subtle palette wash */}
        <div aria-hidden="true" className="pointer-events-none absolute -left-24 -top-24 h-96 w-96 rounded-full bg-violet-200/20 blur-3xl" />
        <div aria-hidden="true" className="pointer-events-none absolute -right-24 -bottom-24 h-[28rem] w-[28rem] rounded-full bg-blue-200/20 blur-3xl" />
        <div aria-hidden="true" className="pointer-events-none absolute left-1/2 top-1/2 h-[40rem] w-[40rem] -translate-x-1/2 -translate-y-1/2 rounded-full bg-indigo-100/20 blur-3xl" />
        <div className="relative mx-auto max-w-7xl">
          <h2 className="text-center text-sm font-bold uppercase tracking-[0.2em] text-primary/60 sm:text-[0.8rem]">Other missions</h2>
          <div className="mt-8 grid gap-4 lg:grid-cols-[1.03fr_0.97fr] lg:items-start lg:gap-6">
            <div className="contents lg:flex lg:flex-col lg:gap-4">
              <div className="order-1">
                <h2 className="max-w-xl text-[1.9rem] font-bold leading-[1.05] tracking-tight text-primary sm:text-4xl lg:text-[2.5rem]">Create Your OneVoice27 Photo</h2>
                ...
                <OneVoiceShare anchor="other-missions" />
              </div>
              <div className="order-3">
                <div className="max-w-xl rounded-2xl border border-primary/10 bg-white/80 p-4 shadow-sm backdrop-blur">
                  <p className="text-[0.7rem] font-bold uppercase tracking-[0.18em] text-primary/50">One global movement</p>
            ...
            <div className="order-2 lg:order-none">
              <PhotoFrameClient frameSrc="/graphic/other-missions.png" />
            </div>
          </div>
        </div>
      </section>
